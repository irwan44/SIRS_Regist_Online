...
public class listcariDokter extends AppCompatActivity {

    String val_token, kd_klinik, nm_klinik, nm_Dokter, nm_dokter, kd_dokter, idnya_dokter, kd_bag, bag, sFoto,
...
//        swipe.setOnRefreshListener(this);
        ...
        if(data!=null){
            kd_klinik = data.get("kodeKlinik").toString();
            nm_klinik = data.get("namaKlinik").toString();
        }
...
//                idDokter = caridokter.get(position).getIdnya_dokter();
...
//                            caridokter.add(new DokterPoli(idDokter,kdDokter,namaDokter));
